        ...
        <div>
            <section className="text-gray-600 body-font mb-10">
                ...
                <div className="container px-5 py-10 mx-auto">
                    ...
                    {/* para  */}
                    <h2 className=' text-center text-2xl font-semibold mb-10' >What our <span className=' text-pink-500'>farmers</span> are saying</h2>
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">"Using Krishi Mitra's advanced tools and resources, I've seen a significant improvement in my farm's productivity. The real-time monitoring feature helps me stay on top of my crops' health, and the AI-driven forecasting ensures I make informed decisions."</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Kamal Nayan Upadhyay</h2>
                                <p className="text-gray-500">Farmer, Maharashtra</p>
                            </div>
                        </div>
